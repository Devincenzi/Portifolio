    ...
    <div class='w-full flex flex-col md:flex-row items-center justify-around text-slate-100 p-3 border-t border-slate-800'>
        ...
        <form action='/api/sendemail' method='POST' class='w-3/4 md:w-1/2 grid grid-cols-6'>
            ...
            <div class='col-span-6 md:col-span-3 input-group'>
                <label>Nome</label>
                <input name='nome' required value="" type='text' class='rounded-md' placeholder="José da Silva"/>
            </div>

            <div class='col-span-6 md:col-span-3 input-group'>
                <label>Assunto</label>
                <input name='assunto' required value="" type='text' class='rounded-md' placeholder="Serviço"/>
            </div>
            ...
            <div class='col-span-6 flex justify-end pr-3 pl-4'>
                <button type="submit" class="text-center text-slate-200 w-full sm:w-auto bg-gradient-to-r 
                    from-sky-500 to-cyan-400 font-semibold text-sm sm:text-base p-2 rounded-md 
                    transition-colors ease-in duration-300 hover:from-sky-600 hover:to-cyan-500">ENVIAR</button>
            </div>
        </form>
    </div>
